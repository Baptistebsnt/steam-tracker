        ...
        <main className="flex flex-1 flex-col justify-center gap-16 py-16">
          <section>
            ...
            <p className="mt-5 max-w-lg text-base text-muted-foreground">
              Steam Tracker surveille tes jeux pendant que tu n'y joues pas&nbsp;: backlog qui
              prend la poussière, baisses de prix, temps de jeu réel.
            </p>
            <div className="mt-8 flex items-center gap-3">
              <Button className="gap-2 bg-amber-400 text-neutral-950 hover:bg-amber-300">
